...
public class YIQConversor extends DigitalProcess {
    ...
    protected int transform(BufferedImage img, int px, int py, Object arg) {
        ...
        if(to_yiq) {
            double[] yiq = this.convertRGBtoYIQ(color);
    ...
    public double[] convertRGBtoYIQ(Color color) {
        int r = color.getRed();
        ...
        double q = ((0.212f * r) - (0.523f * g) + (0.311f * b));       
    ...
    public int[] convertYIQtoRGB(Color color) {
        ...
        int r = (int)Math.round(y + (0.953 * i) + (0.621 * q));
